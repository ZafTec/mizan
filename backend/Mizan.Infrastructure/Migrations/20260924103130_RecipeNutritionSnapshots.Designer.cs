...
namespace Mizan.Infrastructure.Migrations
{
    ...
    [Migration("20260924103130_RecipeNutritionSnapshots")]
    partial class RecipeNutritionSnapshots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiChatThread", b =>
                {
                    ...
                    b.Property<int>("SummarisedThrough")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("summarised_through");
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiEvalCase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("IsAdversarial")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_adversarial");
                    ...
                    b.ToTable("ai_eval_cases", (string)null);
                });

            modelBuilder.Entity("Mizan.Domain.Entities.AiEvalRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("ai_eval_runs", (string)null);
                });

            modelBuilder.Entity("Mizan.Domain.Entities.AiPrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiPromptVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("SoftPolicy")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("{}")
                        .HasColumnName("soft_policy");
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiUsageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.BillingDiscount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("MaximumRecurringIntervals")
                        .HasColumnType("integer")
                        .HasColumnName("maximum_recurring_intervals");

                    b.Property<string>("PaddleDiscountId")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("paddle_discount_id");

                    b.PrimitiveCollection<List<Guid>>("PlanIds")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("plan_ids");
                    ...
                    b.HasIndex("PaddleDiscountId")
                        .IsUnique();

                    b.ToTable("billing_discounts", (string)null);
                });

            modelBuilder.Entity("Mizan.Domain.Entities.BillingPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("PaddleProductId")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("paddle_product_id");
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.ExternalLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.Recipe", b =>
                {
                    ...
                    b.Property<bool>("IsPreparation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_preparation");
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.RecipeNutritionSnapshot", b =>
                {
                    b.Property<Guid>("RecipeId")
                        .HasColumnType("uuid")
                        .HasColumnName("recipe_id");
                    ...
                    b.Property<string>("IngredientsFingerprint")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("ingredients_fingerprint");
                    ...
                    b.ToTable("recipe_nutrition_snapshots", (string)null);
                });
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.Property<DateTime?>("NextBilledAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("next_billed_at");
                    ...
                    b.Property<DateTime?>("PaddleUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("paddle_updated_at");
                    ...
                    b.Property<string>("ScheduledChangeAction")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("scheduled_change_action");

                    b.Property<DateTime?>("ScheduledChangeAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("scheduled_change_at");
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.UserAiConsent", b =>
                {
                    ...
                    b.Property<bool>("ShareBody")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("share_body");

                    b.Property<bool>("ShareNutrition")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("share_nutrition");

                    b.Property<bool>("ShareTraining")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("share_training");
                    ...
                    b.Property<bool>("WriteBody")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("write_body");

                    b.Property<bool>("WriteNutrition")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("write_nutrition");

                    b.Property<bool>("WriteTraining")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("write_training");
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiChatMessage", b =>
                {
                    b.HasOne("Mizan.Domain.Entities.AiChatThread", "Thread")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiEvalRun", b =>
                {
                    b.HasOne("Mizan.Domain.Entities.AiEvalCase", "Case")
                        .WithMany()
                        .HasForeignKey("CaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mizan.Domain.Entities.AiPromptVersion", "Version")
                        .WithMany()
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.AiPromptVersion", b =>
                {
                    b.HasOne("Mizan.Domain.Entities.AiPrompt", "Prompt")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.Food", b =>
                {
                    b.HasOne("Mizan.Domain.Entities.Recipe", "SourceRecipe")
                        .WithMany()
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.RecipeNutritionSnapshot", b =>
                {
                    b.HasOne("Mizan.Domain.Entities.Recipe", null)
                        .WithOne()
                        .HasForeignKey("Mizan.Domain.Entities.RecipeNutritionSnapshot", "RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Mizan.Domain.Entities.UserAiConsent", b =>
                {
                    b.HasOne("Mizan.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Mizan.Domain.Entities.UserAiConsent", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
