...
import type { WeightScope, WorkoutDraft, WorkoutDraftAction } from "@/lib/workouts/draft";
		...
		<div className="space-y-5">
			<div className="card grid gap-4 p-5 sm:grid-cols-3">
				...
				<div className="sm:col-span-2 flex items-end">
					<p className="text-sm text-charcoal-blue-500 dark:text-charcoal-blue-400">
						Tap a set to complete target reps. Tap again to count down to zero and clear it.
					</p>
				</div>
			</div>
			...
			{draft.exercises.length === 0 ? (
				<div className="card p-10 text-center">
					...
					/>
					<h2 className="mt-4 text-lg font-semibold">Add your first exercise</h2>
						...
						<div className="space-y-3 p-4">
							...
							<div className="flex flex-wrap gap-2">
								<button
									...
									onClick={() => dispatch({ type: "add-set", exerciseUid: exercise.uid })}
								>
									Add set
								</button>
