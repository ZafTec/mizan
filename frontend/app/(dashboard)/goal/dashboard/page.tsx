...
export default function GoalDashboard() {
		...
		return (
			<div className="max-w-4xl mx-auto">
				<div className="card p-12 text-center flex flex-col items-center">
					<div className="mb-8 w-full max-w-120 opacity-95">
						<Image
							src="/assets/dashboard-overview.svg"
							alt="Goal dashboard overview"
							width={920}
							height={640}
	...
	const radialData = todayProgress
		? [
				{
					name: "Calories",
					value: Math.min(todayProgress.calories, 100),
					fill: MACRO_COLORS.calories,
				},
				{
					name: "Protein",
					value: Math.min(todayProgress.protein, 100),
		...
		<div className="space-y-6 lg:space-y-8">
			...
			{todayProgress && (
				<div className="card p-6">
					<h2 className="text-xl font-bold text-charcoal-blue-900 dark:text-charcoal-blue-100 mb-6">
						Today's Progress
					</h2>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						...
						<div className="space-y-4">
							{[
								{
									label: "Calories",
									actual: latestEntry.actualCalories,
								...
								{
									label: "Protein",
									actual: latestEntry.actualProteinGrams,
								...
								{
									label: "Carbs",
									actual: latestEntry.actualCarbsGrams,
								...
								{
									label: "Fat",
									actual: latestEntry.actualFatGrams,
					...
					<LineChart data={chartData}>
						...
						{goal.targetCalories && (
							<ReferenceLine
								...
								strokeWidth={2}
								label={{
									value: `Target: ${goal.targetCalories} kcal`,
				...
				<div className="space-y-3">
					{progressEntries
						...
						.map((entry) => (
							<div
								key={entry.id}
								className="flex items-center justify-between p-4 rounded-xl bg-charcoal-blue-50 dark:bg-charcoal-blue-900 hover:bg-charcoal-blue-100 dark:hover:bg-charcoal-blue-800 transition-colors"
							>
								<div>
									...
									{entry.notes && (
										<div className="text-sm text-charcoal-blue-700 dark:text-charcoal-blue-300 mt-1">
											{entry.notes}
										</div>
									)}
								</div>
								<div className="flex gap-6 text-sm">
									<div className="text-center">
										<div className="text-charcoal-blue-700 dark:text-charcoal-blue-300">
											Calories
										</div>
										<div className="font-bold text-charcoal-blue-900 dark:text-charcoal-blue-100">
