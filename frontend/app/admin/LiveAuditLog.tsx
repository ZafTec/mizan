		...
		<div className="bg-card rounded-lg border flex flex-col h-full overflow-hidden">
			<div className="p-4 border-b flex items-center justify-between bg-charcoal-blue-50/50 dark:bg-charcoal-blue-800/50">
				<div className="flex items-center gap-2">
					<div
						className={`w-2 h-2 rounded-sm ${refreshInterval > 0 ? "bg-green-500 animate-pulse" : "bg-charcoal-blue-300 dark:bg-charcoal-blue-700"}`}
					/>
							...
							<button
								...
								className={`px-2 py-1 text-xs rounded-sm transition-all ${
									refreshInterval === interval.value
										? "bg-white dark:bg-charcoal-blue-900 text-primary font-medium"
				...
				{logs.length === 0 && !isLoading ? (
					...
					<div className="divide-y">
						{logs.map((log) => (
							<div
								key={log.id}
								className="p-3 hover:bg-charcoal-blue-50 dark:hover:bg-charcoal-blue-800 transition-colors group"
							>
								...
								<div className="text-sm">
									...
									<span className="text-charcoal-blue-400 dark:text-charcoal-blue-500 font-mono text-[10px] ml-1">
